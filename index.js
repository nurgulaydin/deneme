...
window.addEventListener("load", ()=>{
    ...
    function kisi1() {
        $k1.innerHTML = "Ad: " + kisiler[0].ad + "</br>" + "Soyad:" + kisiler[0].soyad  
         + "</br>" + "Yaş:" + kisiler[0].yas + "</br>" + "Maaş:" +  kisiler[0].maas
     }
     
     function kisi2() {
         $k2.innerHTML = "Ad: " + kisiler[1].ad + "</br>" + "Soyad:" + kisiler[1].soyad  
         + "</br>" + "Yaş:" + kisiler[1].yas + "</br>" + "Maaş:" +  kisiler[1].maas
     }
     
     function kisi3() {
         $k3.innerHTML = "Ad: " + kisiler[2].ad + "</br>" + "Soyad:" + kisiler[2].soyad  
